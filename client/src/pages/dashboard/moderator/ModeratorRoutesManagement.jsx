...
const ModeratorRoutesManagement = () => {
  ...
  useEffect(() => {
    const mockRoutes = [
      ...
      {
        id: 4,
        routeName: "ঢাকা - বনানী",
        routeNameEn: "Dhaka - Banani",
        startLocation: "Bangladesh University of Professionals",
        endLocation: "Banani Road-11",
        distance: "7.8 km",
        duration: "22 minutes",
        schedule: ["07:50", "08:20", "16:40", "17:10"],
        fare: 35,
        status: "active",
        busesAssigned: 2,
        totalPassengers: 28,
        description: "Route connecting university to Banani commercial area",
        waypoints: [
          "BUP Main Gate",
          "Kalabagan",
          "Green Road",
      ...
      {
        id: 5,
        routeName: "ঢাকা - সাভার",
        routeNameEn: "Dhaka - Savar",
        startLocation: "Bangladesh University of Professionals",
        endLocation: "Savar Bus Stand",
        distance: "15.2 km",
        duration: "45 minutes",
        schedule: ["07:30", "08:00", "16:30", "17:00"],
        fare: 45,
        status: "active",
        busesAssigned: 3,
        totalPassengers: 52,
        description: "Extended route to Savar area for distant students",
        waypoints: [
          "BUP Main Gate",
          "Kalabagan",
          "Dhanmondi 27",
...
export default ModeratorRoutesManagement;
