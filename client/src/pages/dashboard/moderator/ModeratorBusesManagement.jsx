...
const ModeratorBusesManagement = () => {
  ...
  useEffect(() => {
    const mockBuses = [
      ...
      },
      {
        ...
        registrationNumber: "DHAKA-GA-11-2022",
        driverAssigned: "নুরুল ইসলাম",
        routeAssigned: "Banani - BUP Campus",
        status: "active",
...
export default ModeratorBusesManagement;
